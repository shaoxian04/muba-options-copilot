...
export interface Surface {
  ...
  /**
   * The live request, once one has been opened on-chain (ADR-0015). Null before that and
   ...
   * RFQ has no price yet, and `acceptRfq` is what pays one. (ADR-0015)
   */
...
export function useSurface(): Surface {
  ...
  /**
   * The FIRST of two signatures: open a sealed-bid request on-chain (ADR-0015).
   *
