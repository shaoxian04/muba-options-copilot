...
The `/rfq` routes are the other money path, and they are a different shape (ADR-0015). A
...
- **[docs/adr/](./docs/adr/)** — the decisions and why they went that way:
  ...
  - [0013](./docs/adr/0013-the-liquidation-price-is-aaves-and-disagreeing-sources-refuse.md) — the Liquidation Price is Aave's, and two disagreeing price sources refuse rather than pick
  - [0014](./docs/adr/0014-cover-is-partial-and-says-by-how-much.md) — a Cover says how much of the Loan it actually covers
  - [0015](./docs/adr/0015-the-rfq-money-path-is-two-signatures-with-a-wait-between-them.md) — an RFQ is two signatures with a wait between them, and no price until a maker answers
...
- [x] RFQ for strikes the book does not carry — the full sealed-bid path, both doors:
      request, wait, a maker's real price, and a second signature to pay it (ADR-0015)
